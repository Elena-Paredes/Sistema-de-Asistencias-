...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO Area (nombreArea, nombreAyudante, Token) VALUES 
    ('$nombreArea', '$nombreAyudante', '$Token')";
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="AgregarArea.php">
                                            <div class="row mb-3">
                                                ...
                                                <div class="form-floating mb-3">
                                                <input class="form-control" id="inputToken" type="text" name="Token" placeholder="Clave de registro" />
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid">
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-block mt-3" name="cancel" onclick="window.location.href='Area.php'">Cancelar</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
